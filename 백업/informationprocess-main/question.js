...
var Questions = {
    ...
    "20231": [
        ...
        `,"answer":['art<br>a<br>a<br>art<br>art'],
        "type":'java'
...
`,
    ...
    "20232": [{"name":'문제 1:다음은 C언어 코드의 문제이다. 보기의 조건에 맞도록 괄호안에 알맞은 코드를 작성하시오.',
        "code":`\n\nint main(void) {
  ...
  return 0;
    ...
    "20233": [{"name":'문제 2: 다음은 JAVA 코드 문제이다. 가지고 있는 돈이 총 4620원일 경우 1000원, 500원, 100원, 10원의 지폐 및 동전을 이용하여 보기의 조건에 맞춰 최소한의 코드를 통해 괄호안을 작성하시오.',
